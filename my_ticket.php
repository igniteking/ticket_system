                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        if ($client_name) {
                                                                            $get_client = mysqli_query($conn, "SELECT * FROM ticket WHERE username LIKE '%$client_name%' AND created_by='$session_email'");
                                                                            $count = mysqli_num_rows($get_client);
                                                                        } else {
                                                                            $get_client = mysqli_query($conn, "SELECT * FROM ticket WHERE created_by='$session_email'");
                                                                            $count = mysqli_num_rows($get_client);
                                                                        }
