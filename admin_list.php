                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        if ($admin_name) {
                                                                            $get_client = mysqli_query($conn, "SELECT * FROM user_data WHERE user_type = 'admin' AND username LIKE '%$admin_name%'");
                                                                            $count = mysqli_num_rows($get_client);
                                                                        } else {
                                                                            $get_client = mysqli_query($conn, "SELECT * FROM user_data WHERE user_type = 'admin'");
                                                                            $count = mysqli_num_rows($get_client);
                                                                        }
