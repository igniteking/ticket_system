            ...
            <div class="main-panel">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="radioOption4">
                                                            Phonepe
                                                            <input class="form-check-input" type="radio" name="radioGroup" id="radioOption4" value="Phonepe">
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="radioOption5">
                                                            NEFT/RTGS
                                                            <input class="form-check-input" type="radio" name="radioGroup" id="radioOption5" value="NEFT/RTGS">
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="radioOption6">
                                                            Shoutlo
                                                            <input class="form-check-input" type="radio" name="radioGroup" id="radioOption6" value="Shoutlo">
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="radioOption7">
                                                            Razorpay
                                                            <input class="form-check-input" type="radio" name="radioGroup" id="radioOption7" value="Razorpay">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <script type="text/javascript">
                    ...
                    function billTotal(str, id) {
                        ...
                        console.log("Excluding amount:  " + excludingGST); // Output: 1000.00
