                                    ...
                                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="statistics-details d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div>
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                <?php
                                                                $z = 0;
                                                                $get_all_tickets = mysqli_query($conn, "SELECT * FROM b2b_ticket");
                                                    ...
                                                    <div>
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage"><?php echo $AMUSEMENT = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%Couple%'")); ?></h3>
                                                        </center>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="statistics-details d-flex align-items-center justify-content-between">
                                                    <div class="d-none d-md-block">
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                <?php
                                                                echo $AMUSEMENT = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%AMUSEMENT%'"));
                                                                ?>
                                                            </h3>
                                                        </center>
                                                    </div>
                                                    <div class="d-none d-md-block">
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                <?php
                                                                echo $WUNDER = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%WUNDER%'"));
                                                                ?>
                                                            </h3>
                                                        </center>
                                                    </div>
                                                    <div class="d-none d-md-block">
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                <?php
                                                                echo $get_all_tickets_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%COMBO%'"));
                                                                ?>
                                                            </h3>
                                                        </center>
                                                    </div>
                                                    <div class="d-none d-md-block">
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage"><?php
                                                                                        echo $get_all_tickets_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%Family%'"));
                                                                                        ?></h3>
                                                        </center>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 card card-body">
                                                <form action="./b2b_report.php" class="form row" method="get">
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                ...
                                                                if ($payment_type == 'All') {
                                                                    ...
                                                                    $day_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE created_at LIKE '$today'");
                                                                } else {
                                                                    $count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE payment_method = '$payment_type' AND created_at LIKE '$today'"));
                                                                    $day_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE payment_method = '$payment_type' AND created_at LIKE '$today'");
                                                                }
                                                                if ($count > 0) {
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                ...
                                                                if ($payment_type == 'All') {
                                                                    ...
                                                                    $week_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE created_at BETWEEN '$date_from' AND '$date_to'");
                                                                } else {
                                                                    ...
                                                                    $week_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE payment_method = '$payment_type' AND created_at BETWEEN '$date_from' AND '$date_to'");
                                                                }
                                                                if ($count > 0) {
                                                    ...
                                                    <div class="d-none d-md-block">
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                ...
                                                                if ($payment_type == 'All') {
                                                                    $month_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE created_at BETWEEN '$month_date_from' AND '$month_date_to'"));
                                                                    $month_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE created_at BETWEEN '$month_date_from' AND '$month_date_to'");
                                                                } else {
                                                                    $month_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE payment_method = '$payment_type' AND created_at BETWEEN '$month_date_from' AND '$month_date_to'"));
                                                                    $month_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE payment_method = '$payment_type' AND created_at BETWEEN '$month_date_from' AND '$month_date_to'");
                                                                }
                                                                if ($month_count > 0) {
                                                        ...
                                                        <center>
                                                            <h3 class="rate-percentage">
                                                                ...
                                                                if ($year_payment_type == 'All') {
                                                                    $year_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE created_at BETWEEN '$year_date_from' AND '$year_date_to'"));
                                                                    $year_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE created_at BETWEEN '$year_date_from' AND '$year_date_to'");
                                                                } else {
                                                                    $year_count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE payment_method = '$year_payment_type' AND created_at BETWEEN '$year_date_from' AND '$year_date_to'"));
                                                                    $year_fetch_data = mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE payment_method = '$year_payment_type' AND created_at BETWEEN '$year_date_from' AND '$year_date_to'");
                                                                }
                                                                if ($year_count > 0) {
                                        ...
                                        <div class="card card-rounded table-darkBGImg">
                                            <div class="card-body">
                                                <div class="col-sm-8">
                                                    ...
                                                    <a href="./index.php" class="btn btn-info upgrade-btn">Create b2b_ticket!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="row" id="notification">
                                                                    <?php
                                                                    $fetch_data_index = mysqli_query($conn, "SELECT * FROM b2b_ticket");
                                                                    $count_index = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket"));
                                                                    if ($count_index == 0) {
                                                                        ...
                                                                        while ($rows = mysqli_fetch_array($fetch_data_index)) {
                                                                            ...
                                                                            echo '
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="">' . str_replace(",", "<br>", $index_ticket_quantity) . '</span></td>
                                                                                    <td class="">' . str_replace(",", "<br>", $index_ticket_name) . '</span></td>
    ...
    <script>
        ...
        function fetch_data(str) {
            if (str == 'today') {
                ...
                xhr.open("GET", "./helpers/today.php?type=b2b&&ticket_type=" + ticket_type);
                ...
                // Define the AJAX request
                // xhr.open("GET", "./helpers/week_year.php?type=b2b&&ticket_type=" + ticket_type + "&&date_from=" + formattedStartDate + "&&date_to=" + formattedEndDate);
                xhr.open("GET", "./helpers/week_year.php?type=b2b&&ticket_type=" + ticket_type + "&&time=weekly");
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                        const response = xhr.responseText;
                        document.getElementById('notification').innerHTML = response;
                ...
                // Define the AJAX request
                xhr.open("GET", "./helpers/week_year.php?type=b2b&&ticket_type=" + ticket_type + "&&time=monthly");
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                        const response = xhr.responseText;
                        document.getElementById('notification').innerHTML = response;
                ...
                // Define the AJAX request
                xhr.open("GET", "./helpers/week_year.php?type=b2b&&ticket_type=" + ticket_type + "&&time=lifetime");
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                        const response = xhr.responseText;
                        document.getElementById('notification').innerHTML = response;
                ...
                // Define the AJAX request
                xhr.open("GET", "./helpers/week_year.php?type=b2b&&ticket_type=" + ticket_type + "&&time=yearly");
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                        const response = xhr.responseText;
                        document.getElementById('notification').innerHTML = response;
                ...
                // Define the AJAX request
                xhr.open("GET", "./helpers/week_year.php?type=b2b&&payment_type=" + str + "&&ticket_type=" + ticket_type);
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                        const response = xhr.responseText;
                        document.getElementById('notification').innerHTML = response;
                ...
                // Define the AJAX request
                xhr.open("GET", "./helpers/week_year.php?type=b2b&&payment_type=" + str + "&&ticket_type=" + ticket_type + "&&date_from=" + startYear + "&&date_to=" + endYear);
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                        const response = xhr.responseText;
                        document.getElementById('notification').innerHTML = response;
        ...
        function onSubmitButton() {
            ...
            // Define the AJAX request
            xhr.open("GET", "./helpers/reports.php?type=b2b&&ticket_type=" + ticket_type2 + "&&date_from=" + date_from2 + "&&date_to=" + date_to2);
            xhr.onreadystatechange = function() {
                if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                    const response = xhr.responseText;
                    document.getElementById('notification').innerHTML = response;
        ...
        const data = {
            ...
            datasets: [{
                type: 'line',
                label: 'b2b_ticket Sold',
                data: [<?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%AMUSEMENT%'")); ?>, <?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%WUNDER WATER%'")) ?>, <?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%COMBO%'")) ?>, <?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%Couple%'")) ?>, <?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM b2b_ticket WHERE ticket_name LIKE '%Family%'")) ?>],
                fill: true,
            }]
        };
        var salesTopOptions = {
